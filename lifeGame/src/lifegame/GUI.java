...
public class GUI extends JFrame implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6446309625588416722L;
	private static GUI frame;
	private Cell cell;
	private int maxLength, maxWidth; // 长和宽
	private JButton[][] nGrid; // 一个按钮表示一个细胞
	private boolean[][] isSelected; // 按钮（即细胞）是否被选中
	private JButton ok, jbNowGeneration, randomInit, clearGeneration; // 确定，当前代数，随机初始化，代数清零
	private JButton clearCell, nextGeneration, start, stop, exit; //清除细胞 下一代，开始繁衍，暂停，退出
	private JComboBox<String> lengthList, widthList;// 长宽选择
